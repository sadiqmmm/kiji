...
#define NEW_LIT(l) NEW_NODE_LONGLIFE(NODE_LIT,REMEMBER(l),0,0)
...
#define NEW_CALL(r,m,a) NEW_NODE_LONGLIFE(NODE_CALL,REMEMBER(r),m,REMEMBER(a))
#define NEW_FCALL(m,a) NEW_NODE_LONGLIFE(NODE_FCALL,0,m,REMEMBER(a))
...
#define NEW_ARGS(f,o,r) NEW_NODE_LONGLIFE(NODE_ARGS,REMEMBER(o),REMEMBER(r),f)
...
#define NEW_SPLAT(a) NEW_NODE_LONGLIFE(NODE_SPLAT,REMEMBER(a),0,0)
#define NEW_TO_ARY(a) NEW_NODE_LONGLIFE(NODE_TO_ARY,REMEMBER(a),0,0)
#define NEW_SVALUE(a) NEW_NODE_LONGLIFE(NODE_SVALUE,REMEMBER(a),0,0)
#define NEW_BLOCK_ARG(v) NEW_NODE_LONGLIFE(NODE_BLOCK_ARG,v,0,local_cnt(v))
#define NEW_BLOCK_PASS(b) NEW_NODE_LONGLIFE(NODE_BLOCK_PASS,0,REMEMBER(b),0)
...
#define NEW_NIL() NEW_NODE_LONGLIFE(NODE_NIL,0,0,0)
#define NEW_TRUE() NEW_NODE_LONGLIFE(NODE_TRUE,0,0,0)
#define NEW_FALSE() NEW_NODE_LONGLIFE(NODE_FALSE,0,0,0)
