    ...
    struct clone_method_data *data;
{
    ...
    st_insert(data->tbl, mid, (st_data_t)NEW_METHOD_LONGLIFE(fbody, body->nd_noex));
    return ST_CONTINUE;
}
...
rb_define_method_id(klass, name, func, argc)
    ...
    int argc;
{
    rb_add_method(klass, name, NEW_CFUNC_LONGLIFE(func,argc), NOEX_PUBLIC);
}
    ...
    int argc;
{
    ...
    rb_add_method(klass, id, NEW_CFUNC_LONGLIFE(func,argc), ex);
}
...
rb_define_protected_method(klass, name, func, argc)
    ...
    int argc;
{
    rb_add_method(klass, rb_intern(name), NEW_CFUNC_LONGLIFE(func,argc), NOEX_PROTECTED);
}
...
rb_define_private_method(klass, name, func, argc)
    ...
    int argc;
{
    rb_add_method(klass, rb_intern(name), NEW_CFUNC_LONGLIFE(func,argc), NOEX_PRIVATE);
}
